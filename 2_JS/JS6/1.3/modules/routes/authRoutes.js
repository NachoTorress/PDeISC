...
import { registrarLoginAdmin } from '../logService.js';
...
router.post('/auth/login', async (req, res) => {
    ...
    try {
        ...
        req.session.regenerate((error) => {
            ...
            registrarLoginAdmin(usuarioValido.usuario).catch((logError) => {
                console.error('Error al registrar login en el log:', logError);
            });
