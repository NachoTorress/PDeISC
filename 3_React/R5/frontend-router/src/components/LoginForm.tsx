  ...
  return (
    <div className="auth-panel">
      ...
      <div className="row g-4 align-items-center">
        {/* Formulario Local (Izquierda) */}
        <div className="col-md-7 border-end-md pe-md-4">
          <form onSubmit={handleSubmit(submit)} noValidate>
            {formError ? <div className="alert alert-danger mb-3">{formError}</div> : null}
            ...
            <button
              type="submit"
              className="btn btn-primary btn-icon-text w-100 mt-2"
        ...
        {/* Botones Redes Sociales (Derecha) */}
        <div className="col-md-5 ps-md-4">
          <div className="text-center text-md-start mb-3 text-muted">
            <small className="fw-semibold">O accedé con tu cuenta social</small>
          </div>

          <div className="d-flex flex-column gap-2">
            <button
              type="button"
              className="btn btn-outline-dark btn-icon-text w-100 d-flex align-items-center justify-content-center py-2"
            ...
            <button
              type="button"
              className="btn btn-outline-danger btn-icon-text w-100 d-flex align-items-center justify-content-center py-2"
            ...
            <button
              type="button"
              className="btn btn-outline-primary btn-icon-text w-100 d-flex align-items-center justify-content-center py-2"
